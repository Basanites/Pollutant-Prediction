...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.display_page = QtWidgets.QWidget(self.statistics_tab)
        self.display_page.setMinimumSize(QtCore.QSize(450, 325))
        self.display_page.setObjectName("display_page")
        self.gridLayout_4.addWidget(self.display_page, 1, 0, 1, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.station_combobox = QtWidgets.QComboBox(self.statistics_tab)
        self.station_combobox.setObjectName("station_combobox")
        self.horizontalLayout.addWidget(self.station_combobox)
        self.pollutant_combobox = QtWidgets.QComboBox(self.statistics_tab)
        self.pollutant_combobox.setObjectName("pollutant_combobox")
        self.horizontalLayout.addWidget(self.pollutant_combobox)
